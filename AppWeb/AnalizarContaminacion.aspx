<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterResult/MasterPageResult.master" AutoEventWireup="true" CodeFile="AnalizarContaminacion.aspx.cs" Inherits="AnalizarContaminacion" %>
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <br />
                <h1>MEDICIÓN DE CONTAMINACION</h1>
                <asp:Panel ID="pnVariables" runat="server">
                    <br />
                    <hr style="width: 960px" />
                    <h2>Contaminacion del Aire</h2>
                    <asp:Panel ID="pnAire" runat="server">
                    </asp:Panel>
                    <br />
                    <hr style="width: 960px" />
                    <h2>Contaminacion del Suelo</h2>
                    <asp:Panel ID="pnSuelo" runat="server"></asp:Panel>
                    <br />
                    <hr style="width: 960px" />
                    <h2>Contaminacion del Agua</h2>
                    <asp:Panel ID="pnAgua" runat="server"></asp:Panel>
                    <br />
                    <hr style="width: 960px" />
                    <h2>Contaminacion del Sonora</h2>
                    <asp:Panel ID="pnSonora" runat="server"></asp:Panel>
                    <br />
                    <hr style="width: 960px" />
                    <h2>Contaminacion Termica</h2>
                    <asp:Panel ID="pnTermica" runat="server"></asp:Panel>
                    <br />
                    <hr style="width: 960px" />
                    <h2>Contaminacion Visual</h2>
                    <asp:Panel ID="pnVisual" runat="server"></asp:Panel>
                </asp:Panel>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
