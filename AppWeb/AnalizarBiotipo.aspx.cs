...
public partial class AnalizarBiotipo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            idioma = (Session["idiomaBuscar"] as string);
            Biotiponodos = (Session["BiotiposNodos"] as List<GeonameNode>);
            //Asignamos las últimas fechas guardadas
            //AsignarRangoFechas(Convert.ToDateTime(Session["fechaInicio"]),
            //                   Convert.ToDateTime(Session["fechaFin"]));
        }
    }
    ...
    private void MostrarBiotipo(Biotipo biotipo)
    {
        ...
        //Edafotopo
        foreach (Variable varCaracteristica in biotipo.Edafotopo.Variables)
        {
            Literal lit = new Literal();
            lit.Text = CrearEncabezadoVariable(varCaracteristica);
            pnEdatopo.Controls.Add(lit);
            ...
            pnEdatopo.Controls.Add(gridSen);
        }

        //Hidrotopo
        foreach (Variable varCaracteristica in biotipo.Hidrotopo.Variables)
        {
            Literal lit = new Literal();
            lit.Text = CrearEncabezadoVariable(varCaracteristica);
            pnHidrotopo.Controls.Add(lit);
            ...
            ((Controles_GridSensores)gridSen).FechaInicio = fechainicio;
            ((Controles_GridSensores)gridSen).FechaFin = fechaFin;
            pnHidrotopo.Controls.Add(gridSen);
        }

        //Climatopo
        foreach (Variable varCaracteristica in biotipo.Climatopo.Variables)
        {
            Literal lit = new Literal();
            lit.Text = CrearEncabezadoVariable(varCaracteristica);
            pnClimatopo.Controls.Add(lit);
            ...
            ((Controles_GridSensores)gridSen).FechaInicio = fechainicio;
            ((Controles_GridSensores)gridSen).FechaFin = fechaFin;
            pnClimatopo.Controls.Add(gridSen);
        }
    ...
    private void BuscaryAnalizarBiotipo()
    {
        ...
        Biotipo biotipo = bm.ObtenerInfoBiotipoMedioAmbiente(Biotiponodos[drplLugares.SelectedIndex], radio, idioma);
